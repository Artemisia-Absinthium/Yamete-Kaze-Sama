...
public class GameControllerScript : MonoBehaviour
{
    ...
    private void missionKO()
    {
        ...
        tmp.a = 0.0f;
        HUDDefis.GetComponent<SpriteRenderer>().color = tmp;
        printScore(new Vector2(HUDDefis.transform.position.x, HUDDefis.transform.position.y - 0.5f), "Echec =(");
    ...
    private void missionOK(int nbPoint)
    {
        ...
        tmp.a = 0.0f;
        HUDDefis.GetComponent<SpriteRenderer>().color = tmp;
        printScore(new Vector2(HUDDefis.transform.position.x, HUDDefis.transform.position.y - 0.5f), "Bien joué +" + nbPoint.ToString());
